...
import com.main.neosoft.entity.UserContact;
...
public class UserContactDetailsController {
	...
	UserContactDetailsRepository userContactRepo;
	 ...
	 public ResponseEntity<List<UserContact>> getAllContactDetailsByUserId (@PathVariable("userId") Long id) {
			if(!userDetailsRepo.existsById(id)) {
				throw new ResourceNotFoundException("User Not Found with id = " +id);
			}
			
			List<UserContact> contactDetails = userContactRepo.findByUserContactId(id);
